...
class Nota {
    constructor(nome_aluno, nota, id_aluno, id_lista_teorica, nome_lista_teorica, perguntas_certas, perguntas_erradas) {
...
class Nota_Service {
    ...
    inserir(nome_aluno, nota, id_aluno, id_lista_teorica, nome_lista_teorica, perguntas_certas, perguntas_erradas) {
        return fetch(this.url, {
            method: "POST",
            body: JSON.stringify(nome_aluno, nota, id_aluno, id_lista_teorica, nome_lista_teorica, perguntas_certas, perguntas_erradas),
            headers: {
...
document.getElementById("notas").onclick = function () {
    ...
    let nota_service = new Nota_Service(`http://localhost:3000/notas?id_aluno=${id_login}`);
                                            ...
                                            document.getElementById("proxima_pergunta").onclick = function () {
                                                ...
                                                if (typeof input_radio_situacao != "undefined") {
                                                    ...
                                                    if (encerrar == posicao_pergunta) {
                                                        ...
                                                        let nota_class = new Nota(nome_login, nota_final, id_login, id_lista_teorica, nome_lista_teorica_automatica, lista_perguntas_certas_user, pergunta_final_errada);
                        ...
                        pergunta_service.listar().then(resposta => {
                            ...
                            for (let i = 0; i <= resposta.length - 1; i++) {
                                ...
                                button.onclick = function () {
                                    ...
                                    $("#contador_perguntas").text(`${contador_perguntas_adicionadas}/10 no minímo 10 perguntas no máximo 10 perguntas`);
                                    lista_pergunta_server.push(button.textContent);
                                    opcoes_server.push(resposta[i].opcoes);
                                                            ...
                                                            document.getElementById("fazer_perguntas_erradas").onclick = function () {
                                                                ...
                                                                document.getElementById("proxima_pergunta").onclick = function () {
                                                                    ...
                                                                    if (typeof input_radio_situacao != "undefined") {
                                                                        ...
                                                                        lugar_perguntas.innerHTML = `${t_number}/${lista_perguntas_erradas_usuario.length-1})  ${lista_perguntas_erradas_usuario[posicao_pergunta]}`;
                                                                        for (let i = 0; i <= lugar_opcoes_resposta.length - 1; i++) {
                                                                            lugar_opcoes_resposta[i].innerHTML = lista_opcoes2s[posicao_opcoes];
                                                                            input_radio[i].setAttribute('value', lista_opcoes2s[posicao_opcoes]);
                                                                            posicao_opcoes++
                                                                        ...
                                                                        if (encerrar == posicao_pergunta) {
                                                                            ...
                                                                            let nota_class = new Nota(nome_login, nota_final, id_login, id_lista_teorica, input_nome, lista_certas_usuario, pergunta_final_errada);
                                                                            let nota_service = new Nota_Service("http://localhost:3000/notas");
                                                                            nota_service.inserir(nota_class).then(resposta => {
                                                                                console.log(resposta);
                                                                            })
                            ...
                            nota_service.listar().then(resposta => {
                                if (resposta.length > 0) {
                                    ...
                                    lista_teorica_service.listar().then(resposta => {
                                        ...
                                        var nome_lista_teorica = resposta[0].nome
                                        ...
                                        document.getElementById("proxima_pergunta").onclick = function () {
                                            ...
                                            if (typeof input_radio_situacao != "undefined") {
                                                ...
                                                if (posicao_pergunta == 10) {
                                                    ...
                                                    let ul_resposta_certa = document.getElementById("reposta_certa");
                                                    let ul_resposta_errada = document.getElementById("pergunta_errada");
                                                    let nota_class = new Nota(nome_login, nota, id_login, id_lista_teorica, nome_lista_teorica, lista_certas_usuario, lista_erradas_usuario);
                                                    let nota_service = new Nota_Service("http://localhost:3000/notas");
                                                    nota_service.inserir(nota_class).then(resposta => {
                                                        console.log(resposta);
                                                    })
